...
private:
	...
	FullInliner(Block& _ast, YulNameDispenser& _dispenser, Dialect const& _dialect);
	void run(Pass _pass);
...
{
public:
	InlineModifier(FullInliner& _driver, YulNameDispenser& _nameDispenser, YulName _functionName, Dialect const& _dialect):
