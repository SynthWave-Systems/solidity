...
inline std::string stackSlotToString(StackSlot const& _slot, YulNameLabelRegistry const& _labels, Dialect const& _dialect)
{
...
inline std::string stackToString(Stack const& _stack, YulNameLabelRegistry const& _labels, Dialect const& _dialect)
{
	std::string result("[ ");
