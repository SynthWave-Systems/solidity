...
struct CopyTranslate: public yul::ASTCopier
{
	CopyTranslate(
		...
		yul::YulNameLabelRegistry const& _labels,
		yul::YulNameLabelRegistryBuilder& _labelsBuilder,
...
private:
	...
	yul::YulNameLabelRegistry const& m_labels;
	yul::YulNameLabelRegistryBuilder& m_labelsBuilder;
...
bool IRGeneratorForStatements::visit(InlineAssembly const& _assembly)
{
	...
	yul::YulNameLabelRegistryBuilder labelBuilder{originalLabels};
