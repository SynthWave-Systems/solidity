...
{
public:
	YulLValueChecker(ASTString const& _identifierName, yul::YulNameLabelRegistry const& _yulLabels): m_identifierName(_identifierName), m_yulLabels(_yulLabels) {}
...
private:
	...
	yul::YulNameLabelRegistry const& m_yulLabels;
