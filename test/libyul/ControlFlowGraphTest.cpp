...
namespace
{
std::string_view variableSlotToString(VariableSlot const& _slot, YulNameLabelRegistry const& _labels)
{
...
{
public:
	ControlFlowGraphPrinter(std::ostream& _stream, Dialect const& _dialect, YulNameLabelRegistry const& _labels):
		m_stream(_stream),
		m_dialect(_dialect),
		m_labels(_labels)
	{
